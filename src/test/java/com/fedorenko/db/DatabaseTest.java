...
public class DatabaseTest {
    ...
    public void deleteDuplicateRowsTest(){
        ...
        table.getRows().clear();
        table.addRow(Arrays.asList("iphone", 1000, 5.0, "rgb(0,0,0)"));
        table.addRow(Arrays.asList("xiaomi", 2000, 9.0, "rgb(0,0,0)"));
        table.addRow(Arrays.asList("samsung", 1000, 7.0, "rgb(255,255,255)"));
        table.addRow(Arrays.asList("iphone", 1000, 5.0, "rgb(0,0,0)"));
        table.addRow(Arrays.asList("xiaomi", 2000, 9.0, "rgb(0,0,0)"));
        table.addRow(Arrays.asList("iphone", 1000, 5.0, "rgb(255,0,0)"));
        table.addRow(Arrays.asList("iphone", 2000, 5.0, "rgb(0,0,0)"));
